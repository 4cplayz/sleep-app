...
export default function ProfileScreen() {
  ...
  const handleResetApp = async () => {
    Alert.alert(
      'Reset App',
      'Are you sure you want to reset the app? This will clear all your data and start fresh.',
      [
        {
          text: 'Cancel',
          style: 'cancel',
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.resetButton} onPress={handleResetApp}>
          <Ionicons name="refresh-outline" size={22} color={colors.functional.warning} />
